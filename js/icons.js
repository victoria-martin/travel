/*
  Lucide (ISC), copied in rather than loaded from a CDN: the app has to run offline, and a screen
  rebuilt with innerHTML leaves no single place to walk the DOM again after each render.
  Each body is the inside of the original 24x24 <svg>, stroked in currentColor, so an icon takes
  the colour and the size of the text that carries it.
*/
const ICON_BODIES = {
  ...
  cloud: `<path d="M7 19a4 4 0 0 1-.8-7.94A6 6 0 0 1 18.2 9.8 4 4 0 0 1 17 19z" /> <path d="M7 19a4 4 0 0 1 0-8 6 6 0 0 1 11.2 2.2A4 4 0 0 1 17 19z" />`,
  'cloud-sun': `<circle cx="16" cy="8" r="4" /> <path d="M16 2v2" /> <path d="M16 14v2" /> <path d="M9 18a3 3 0 0 1 0-6 4.5 4.5 0 0 1 8.5 1.5A3.5 3.5 0 0 1 18 18z" /> <path d="M3 12h2" /> <path d="M19 12h2" /> <path d="M5.64 5.64l1.42 1.42" /> <path d="M17.94 17.94l1.42 1.42" />`,
  ...
  siren: `<path d="M7 18v-6a5 5 0 1 1 10 0v6" /> <path d="M5 21a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1H6a1 1 0 0 0-1 1z" /> <path d="M21 12h1" /> <path d="M18.5 4.5 18 5" /> <path d="M2 12h1" /> <path d="M12 2v1" /> <path d="M4.929 4.929 6 6" /> <path d="M12 18h.01" />`,
...
/*
  Not named `icon`: a toolbar button, a tab and a nav item all call `icon` the markup they receive,
  and a global of that name would be shadowed inside each of them.
