...
const PLAN_TYPES = [
  { label: 'page', emoji: '📑', variant: 'warning' },
  { label: 'table', emoji: '📋', variant: 'warning' },
  { label: 'feature', emoji: '✨', variant: 'focus' },
  { label: 'écran', emoji: '🖼️', variant: 'info' },
  { label: 'layout', emoji: '📐', variant: 'info' },
  { label: 'données', emoji: '💾', variant: 'info' },
  { label: 'modal', emoji: '🪟', variant: 'default' },
